      ...
      return (
        <View style={styles.container0}>
          <TouchableOpacity
            style={styles.card}
            onPress={() =>
              navigation.navigate("Prescription", { app_id: item.app_id,
                p_id: item.app_patient_id,
                dr_id: item.dr_id,})
            }
          >
            <View style={styles.userInfo}>
              ...
              <View style={styles.textSection}>
                <View style={styles.userInfoText}>
                  ...
                  <View>
                    <View>
                      <Text style={styles.rate}>{item.app_date}</Text>
                    </View>
                  </View>
                </View>
                <View style={styles.userInfoText}>
                  ...
                  <View style={styles.rateinfo}>
                    <Text style={styles.rate}>{item.app_time}</Text>
